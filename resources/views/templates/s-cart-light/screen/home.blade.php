...
@section('news')
  ...
  <section class="section section-xxl section-last bg-gray-21">
    ...
    <!-- Owl Carousel-->
    <div class="owl-carousel owl-style-7" data-items="1" data-sm-items="2" data-xl-items="3" data-xxl-items="3" data-nav="true" data-dots="true" data-margin="30" data-autoplay="true">
      ...
      <article class="post post-creative"><a class="post-creative-figure" href="{{ $blog->getUrl() }}"><img src="https://images.theconversation.com/files/350865/original/file-20200803-24-50u91u.jpg?ixlib=rb-1.1.0&q=45&auto=format&w=1200&h=900.0&fit=crop" alt="" width="420" height="368"/></a>
